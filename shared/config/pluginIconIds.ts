...
export const PLUGIN_ICON_IDS = [
  ...
  "layout-panel-top",
  "daintree",
  // App-shaped glyphs for project plugins that stand in for a whole tool — a
  // ledger, a board, a calendar, a gallery — where the developer set above
  // has nothing that reads as the thing.
  "wallet",
  "receipt",
  "chart-column",
  "chart-line",
