...
export const theme: BuiltInThemeSource = {
  ...
  tokens: {
    ...
    "search-match-badge-text": "#BAB0CC",
  ...
  extensions: {
    ...
    "dock-bg": "#171519",
    "dock-shadow": "0 -1px 4px rgba(15,12,18,0.30)",
    "settings-dialog-bg": "#2C2831",
    "settings-card-bg": "#3E3845",
    "settings-list-item-bg": "#3E3845",
    "settings-header-bg": "rgba(23,21,25,0.60)",
