...
export const theme: BuiltInThemeSource = {
  ...
  tokens: {
    ...
    "surface-inset": "#E8EFD9",
    "surface-toolbar": "#EEF3E2",
    "terminal-black": "#182B1B",
    "terminal-white": "#DCE6D9",
  },
  extensions: {
    "terminal-grid-bg": "#F5F8EF",
    "settings-dialog-bg": "#FAFCF5",
    "settings-card-bg": "#FCFDF8",
    "settings-list-item-bg": "#FCFDF8",
    "pulse-before-bg": "#E8EFD9",
