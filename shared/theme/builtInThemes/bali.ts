...
export const theme: BuiltInThemeSource = {
  ...
  extensions: {
    ...
    "settings-nav-active-bg": "rgba(192,152,42,0.10)",
    "settings-nav-active-shadow":
      "inset 0 0 0 1px rgba(192,152,42,0.25), inset 0 1px 0 rgba(255,250,236,0.50), inset 0 1px 2px rgba(20,40,25,0.02)",
    ...
    "toolbar-project-bg":
      "linear-gradient(180deg, rgba(30,48,30,0.02), rgba(25,45,28,0.05)), linear-gradient(135deg, #EDF0E6, #E2DDD4)",
