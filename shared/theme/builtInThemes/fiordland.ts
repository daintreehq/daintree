...
export const theme: BuiltInThemeSource = {
  ...
  extensions: {
    ...
    "dock-bg": "#080D14",
    "dock-shadow": "0 -1px 4px rgba(4,7,15,0.30)",
    "settings-dialog-bg": "#111C29",
    "settings-card-bg": "#1A2C3E",
    "settings-list-item-bg": "#1A2C3E",
    "settings-header-bg": "rgba(8,13,20,0.60)",
    "settings-kbd-bg": "#1A2C3E",
    "settings-sidebar-bg": "rgba(8,13,20,0.50)",
