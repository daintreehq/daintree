...
export const theme: BuiltInThemeSource = {
  ...
  tokens: {
    ...
    "surface-inset": "#EDEAE4",
    "surface-toolbar": "#F0ECE7",
  ...
  extensions: {
    "terminal-grid-bg": "#F9F7F4",
    "dock-bg": "#F0ECE7",
    "dock-shadow": "0 -1px 4px rgba(60,48,38,0.04)",
    "settings-dialog-bg": "#FBFAF7",
    "settings-card-bg": "#FEFCFA",
    "settings-list-item-bg": "#FEFCFA",
    "pulse-before-bg": "#EDEAE4",
    "pulse-card-bg": "#FEFCFA",
    ...
    "settings-search-bg": "#F6F3EE",
    "settings-sidebar-bg": "rgba(226,220,212,0.50)",
    "sidebar-action-hover-bg": "rgba(60,48,38,0.06)",
    "sidebar-active-bg": "#FEFCFA",
    "sidebar-active-shadow": "0 1px 3px rgba(60,48,38,0.06)",
