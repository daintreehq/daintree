...
export const theme: BuiltInThemeSource = {
  ...
  extensions: {
    ...
    "dock-bg": "#EEF1F8",
    "dock-shadow": "0 -1px 4px rgba(86,81,118,0.04)",
    "settings-dialog-bg": "#FDFCFF",
    "settings-card-bg": "#FDFCFF",
    "settings-list-item-bg": "#FDFCFF",
    ...
    "sidebar-active-shadow": "0 1px 2px rgba(86,81,118,0.04)",
    ...
    "toolbar-project-shadow": "inset 0 1px 0 rgba(255,255,255,0.25)",
