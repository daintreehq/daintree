...
export const theme: BuiltInThemeSource = {
  ...
  tokens: {
    ...
    "surface-inset": "#ECEAE4",
    "surface-toolbar": "#F0ECE6",
    "terminal-black": "#24201D",
    "terminal-bright-black": "#6B6560",
    "terminal-white": "#DFD7CD",
  },
  extensions: {
    "terminal-grid-bg": "#F9F7F3",
    "dock-bg": "#EDEAE4",
    "dock-shadow": "0 -1px 4px rgba(51,43,35,0.04)",
    "settings-dialog-bg": "#F9F7F3",
    "settings-header-bg": "rgba(240,236,230,0.50)",
    "settings-sidebar-bg": "rgba(236,232,224,0.50)",
    "settings-search-bg": "#F5F2ED",
    "settings-card-bg": "#FCFAF7",
    "settings-list-item-bg": "#FCFAF7",
    "pulse-before-bg": "#ECEAE4",
    "pulse-card-bg": "#F9F7F4",
    "pulse-card-shadow": "0 1px 3px rgba(51,43,35,0.06)",
    "pulse-control-hover-bg": "rgba(51,43,35,0.02)",
    "pulse-empty-bg": "#F3F0EC",
    "pulse-missed-bg": "rgba(163,84,74,0.10)",
    "pulse-range-bg": "#F3F0EC",
    "pulse-ring-offset": "#F9F7F4",
    "pulse-skeleton-gradient": "linear-gradient(90deg, #E8E4DE 25%, #F0ECE6 50%, #E8E4DE 75%)",
