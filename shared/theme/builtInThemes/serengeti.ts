...
export const theme: BuiltInThemeSource = {
  ...
  tokens: {
    ...
    "surface-inset": "#F0E6CE",
    "surface-toolbar": "#F4ECD6",
  ...
  extensions: {
    "terminal-grid-bg": "#FAF5E8",
    "settings-dialog-bg": "#FEFBF4",
    "settings-card-bg": "#FFFCF5",
    "settings-list-item-bg": "#FFFCF5",
    "pulse-before-bg": "#F0E6CE",
