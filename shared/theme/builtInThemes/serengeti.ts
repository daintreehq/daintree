...
export const theme: BuiltInThemeSource = {
  ...
  tokens: {
    ...
    "surface-inset": "#F4EDDA",
    "surface-toolbar": "#F7F1E0",
  ...
  extensions: {
    "terminal-grid-bg": "#FDFBF5",
    "dock-bg": "#F7F1E0",
    "dock-shadow": "0 -1px 4px rgba(44,33,15,0.04)",
    "settings-dialog-bg": "#FEFCF6",
    "settings-header-bg": "rgba(247,241,224,0.50)",
    "settings-kbd-bg": "#F8F2E2",
    "settings-card-bg": "#FFFDF7",
    "settings-list-item-bg": "#FFFDF7",
    "pulse-before-bg": "#F4EDDA",
    "pulse-card-bg": "#FFFDF7",
    "pulse-card-shadow": "0 1px 3px rgba(44,33,15,0.07)",
    "pulse-control-hover-bg": "rgba(44,33,15,0.03)",
    "pulse-empty-bg": "#FCF8EE",
    "pulse-missed-bg": "rgba(173,72,58,0.10)",
    "pulse-range-bg": "#FCF8EE",
    "pulse-ring-offset": "#FFFCF5",
    "pulse-skeleton-gradient": "linear-gradient(90deg, #F2EAD4 25%, #F9F3E0 50%, #F2EAD4 75%)",
    ...
    "settings-search-bg": "#F5ECD8",
    "settings-sidebar-bg": "#F0E6D0",
