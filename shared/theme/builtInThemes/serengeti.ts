...
export const theme: BuiltInThemeSource = {
  ...
  tokens: {
    ...
    "focus-ring": "rgba(147,115,5,0.42)",
    "pr-closed": "#D42531",
    "pr-draft": "#8E97A1",
    "pr-merged": "#8753E4",
    "pr-open": "#1D853A",
  ...
  extensions: {
    ...
    "settings-nav-active-bg": "rgba(147,115,5,0.22)",
    "settings-nav-active-shadow":
      "0 1px 3px rgba(44,33,15,0.08), inset 0 0 0 1px rgba(147,115,5,0.28)",
    "settings-nav-hover-bg": "rgba(147,115,5,0.08)",
    "settings-search-bg": "#EBDDBC",
    "settings-sidebar-bg": "#E2D3AC",
    "sidebar-action-hover-bg": "rgba(147,115,5,0.08)",
    "sidebar-active-bg": "rgba(0,0,0,0.06)",
    "sidebar-hover-bg": "rgba(0,0,0,0.04)",
    "toolbar-agent-hover-bg": "rgba(147,115,5,0.07)",
    "toolbar-control-hover-bg": "rgba(147,115,5,0.08)",
    ...
    "toolbar-stats-bg": "rgba(147,115,5,0.07)",
    "toolbar-stats-border": "rgba(212,196,153,0.55)",
    "toolbar-stats-divider": "rgba(212,196,153,0.55)",
    "toolbar-stats-hover-bg": "rgba(147,115,5,0.08)",
    "worktree-section-hover-bg": "rgba(147,115,5,0.08)",
  },
};
