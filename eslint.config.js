...
import componentContract from "./scripts/eslint-rules/component-contract/index.js";
...
export default tseslint.config(
  ...
  // Global ignores
  {
    ignores: [
      ...
      "release/**",
      "node_modules/**",
      // Vendored submodule (the Go assistant engine). Another repo's source tree —
      // it has its own toolchain and lint gates.
      "vendor/**",
      // Generated by `captureAssistantStates.mts` from real engine output.
