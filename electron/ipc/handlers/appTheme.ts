 ...
 *
 * Exported because writing `appTheme` is not confined to these handlers:
 * importing a configuration bundle writes the same keys and owes the strip the
 * same repaint.
 */
export function refreshTitleBarOverlayTheme(): void {
