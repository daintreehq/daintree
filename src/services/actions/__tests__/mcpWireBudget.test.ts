...
describe("MCP wire budget — aggregate ratchets (§9)", () => {
  ...
  // 220_600 → 226_300 for #12491's four terminal-watch tools, measured at
  // 226_300 B. In-app only — an api-key client has no pane to wake, so the
  ...
  const MAX_COHORT_PAYLOAD_BYTES = 226_300;
