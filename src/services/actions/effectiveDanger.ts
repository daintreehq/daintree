 ...
 *
 * The single extraction point — the gate and the confirm preview both read it
 * here, so the dispatch that gets gated and the recipe that gets previewed can
 * never be resolved by two subtly different rules.
 */
