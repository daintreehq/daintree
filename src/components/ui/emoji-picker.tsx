  ...
  return (
    ...
    >
      <EmojiPickerPrimitive.Search
        className="z-10 mx-2 mt-2 appearance-none rounded-[var(--radius-md)] bg-daintree-bg border border-daintree-border px-3 py-2 text-sm text-daintree-text placeholder:text-text-placeholder focus:outline-hidden focus:border-daintree-accent/40 focus:ring-1 focus:ring-daintree-accent/30"
