...
const inputVariants = cva(
  "w-full bg-surface-input border border-border-input rounded-[var(--radius-md)] text-text-primary placeholder:text-text-placeholder transition-colors duration-150 ease-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent-primary focus-visible:outline-offset-2 disabled:opacity-50 disabled:cursor-not-allowed",
  {
    variants: {
      density: {
