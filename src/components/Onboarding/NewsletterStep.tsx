...
// TODO: Replace with actual MailerLite signup form URL (https://www.mailerlite.com/)
const NEWSLETTER_SIGNUP_URL = "https://www.mailerlite.com/";
...
export const NewsletterStep = forwardRef<HTMLHeadingElement, NewsletterStepProps>(
  function NewsletterStep({ onDismiss }, ref) {
    const handleSubscribe = () => {
      void window.electron.system.openExternal(NEWSLETTER_SIGNUP_URL);
      void onDismiss(true);
    };
