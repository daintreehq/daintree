    ...
    >
      ...
      <div className="settings-section-header sticky top-0 z-20 -mx-6 px-6 pb-1.5">
        ...
        >
          ...
          {title}
          {badge && (
            <span className="inline-flex items-center px-1.5 py-0.5 rounded-sm text-[10px] font-medium bg-text-secondary/10 dark:bg-text-secondary/20 border border-daintree-border/50 text-daintree-text/50 uppercase tracking-wide">
              {badge}
            </span>
          )}
        </h4>
