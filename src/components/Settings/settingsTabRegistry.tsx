  ...
  // ═══ Global — General ═══
  {
    ...
    sections: [
      ...
      },
      {
        ...
        description: "Show the agent's current task next to its name in tabs and panel headers",
        keywords: ["agent", "task", "title", "tab", "terminal", "panel", "header", "name"],
      },
      {
        ...
        description:
          "Minimize motion across the interface, independent of your OS reduce-motion setting",
        keywords: ["animation", "motion", "reduce", "accessibility", "transition", "performance"],
      },
    ],
    ...
    sections: [
      {
        ...
        description:
          "Open the plugin manager to install from a file or URL, enable or disable, uninstall, and check for updates.",
        keywords: [
          "install",
          "plugin",
          "plugins",
