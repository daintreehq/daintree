/**
 * Source: https://github.com/lobehub/lobe-icons (Grok mark, MIT)
 */

import type { SVGProps } from "react";
import { cn } from "@/lib/utils";

type GrokIconProps = SVGProps<SVGSVGElement> & {
  size?: number;
  brandColor?: string;
};

export function GrokIcon({ className, size = 16, brandColor, ...props }: GrokIconProps) {
  return (
    <svg
      width={size}
      height={size}
