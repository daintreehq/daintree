...
// Sidebar takes its width constants from AppLayout, and importing it for real drags in
...
// values are stand-ins; nothing here exercises the width reset or limits.)
vi.mock("../AppLayout", () => ({
