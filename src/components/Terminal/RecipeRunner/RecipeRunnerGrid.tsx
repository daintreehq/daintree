  ...
  return (
    <div onKeyDown={onKeyDown}>
      ...
      <button
        ...
        type="button"
        onClick={onCreate}
        className="group w-full flex items-center justify-center gap-2 px-3 py-2 mt-2 rounded-[var(--radius-md)] hover:bg-overlay-medium transition-colors text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-canopy-accent aria-selected:ring-2 aria-selected:ring-canopy-accent/60"
      >
        <Plus
