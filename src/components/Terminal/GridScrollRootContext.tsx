 ...
 * the viewport) when panels are mounted inside the grid, including its
 * two-pane split layout. Panels mounted outside the grid (dock, popout) read
 * `null` and fall back to the viewport root, which is the right default for
 * those surfaces.
 *
