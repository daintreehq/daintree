...
| `terminalNotify.ts` | Terminal notices: `notify: true` on the submit paths and `terminal.notifyWhenIdle`, and the guarded line that delivers them into the caller's own prompt. |
