...
| `full` | core ∪ `FULL_TIER_ADDONS` — recipes, workflows, project checks, forge and git reads, CopyTree, the unscoped worktree delete and resource lifecycle, kill/restart/close-all, pane watches, skills, diagnostics, and the plugin-authoring loop. |
