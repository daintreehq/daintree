...
| Move terminal left in grid | `⌘+⇧+⌥+ArrowLeft` | `Ctrl+Shift+Alt+ArrowLeft` |
| Move terminal right in grid | `⌘+⇧+⌥+ArrowRight` | `Ctrl+Shift+Alt+ArrowRight` |
| Move terminal up in grid | `⌘+⇧+⌥+ArrowUp` | `Ctrl+Shift+Alt+ArrowUp` |
| Move terminal down in grid | `⌘+⇧+⌥+ArrowDown` | `Ctrl+Shift+Alt+ArrowDown` |
...
| Focus terminal above | `⌘+⌥+ArrowUp` | `Ctrl+Alt+ArrowUp` |
| Focus terminal below | `⌘+⌥+ArrowDown` | `Ctrl+Alt+ArrowDown` |
| Focus terminal to the left | `⌘+⌥+ArrowLeft` | `Ctrl+Alt+ArrowLeft` |
| Focus terminal to the right | `⌘+⌥+ArrowRight` | `Ctrl+Alt+ArrowRight` |
