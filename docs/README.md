...
| [sveltekit-site-builder.md](./architecture/sveltekit-site-builder.md) | SvelteKit Tools: how a click in a dev preview resolves to a source node, and the four operations allowed to write it. |
